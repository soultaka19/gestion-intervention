  ...
  template: `
    <div class="h-16 flex items-center px-4 border-b border-primary-100 justify-between flex-shrink-0 bg-gradient-to-r from-primary-50 to-white">
      @if (!isCollapsed()) {
        ...
        <div class="w-10 h-10 bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg ring-2 ring-primary-100 mx-auto">
        <button
            pButton
            type="button"
            icon="pi pi-bars"
